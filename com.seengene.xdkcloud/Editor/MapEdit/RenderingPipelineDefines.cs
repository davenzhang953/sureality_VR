...
public class RenderingPipelineDefines
{
    ...
    static PipelineType GetPipeline()
    {
        ...
        if (GraphicsSettings.defaultRenderPipeline != null) // graphics settings
        {
            asset = GraphicsSettings.defaultRenderPipeline;
        } 
        if (QualitySettings.renderPipeline != null) // quality settings
        {
            asset = QualitySettings.renderPipeline;
        }
        if (asset != null)
        {
            var srpType = asset.GetType().ToString();
