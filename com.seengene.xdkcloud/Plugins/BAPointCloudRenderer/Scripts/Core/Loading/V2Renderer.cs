...
namespace BAPointCloudRenderer.Loading
{
    ...
    class V2Renderer : AbstractRenderer
    {
        ...
        public V2Renderer(AbstractPointCloudSet pcset, int minNodeSize, uint pointBudget, uint nodesLoadedPerFrame, uint nodesGOsperFrame, Camera camera, MeshConfiguration config, uint cacheSize, GameObject pcSetObj)
        {
            this.pcset = pcset;
            ...
            loadingThread.Start();
            traversalThread = new V2TraversalThread(pcSetObj, this, loadingThread, rootNodes, minNodeSize, pointBudget, nodesLoadedPerFrame, nodesGOsperFrame, cache);
        ...
        public void ShutDown()
        {
            ...
            var defaultConfig = config as DefaultMeshConfiguration;
            if (defaultConfig != null)
            {
                defaultConfig.CheckPointNum();
            }
        }
