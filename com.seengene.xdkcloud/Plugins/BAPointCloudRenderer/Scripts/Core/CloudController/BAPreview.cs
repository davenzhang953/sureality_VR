...
namespace BAPointCloudRenderer.CloudController
{
    ...
    /// </summary>
    [ExecuteAlways]
    public class BAPreview : MonoBehaviour
    {
        ...
        public void UpdatePreview()
        {
            ...
            for (int i = 0; i < allLoaders.Length; ++i)
            {
                ...
                {
                    allLoaders[i].cloudFullPath = Path.Combine(Application.persistentDataPath, allLoaders[i].cloudPath);
        ...
        private void LoadBoundingBoxes()
        {
            ...
            foreach (PointCloudLoader loader in _loaders)
            {
                ...
                PointCloudMetaData metaData = CloudLoader.LoadMetaData(path, loader.cloudFullPath, false);
